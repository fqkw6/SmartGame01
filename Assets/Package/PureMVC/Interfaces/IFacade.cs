...
namespace PureMVC.Interfaces
{
    ...
    public interface IFacade: INotifier
    {
        ...
        IProxy RetrieveProxy(ProxyName proxyName);
        ...
        IProxy RemoveProxy(ProxyName proxyName);
        ...
        bool HasProxy(ProxyName proxyName);
        ...
        void RegisterCommand(NotificationName notificationName, Func<ICommand> commandFunc);
        ...
        bool HasCommand(NotificationName notificationName);
        ...
        IMediator RetrieveMediator(PanelName mediatorName);
        ...
        IMediator RemoveMediator(PanelName mediatorName);
        ...
        bool HasMediator(PanelName mediatorName);

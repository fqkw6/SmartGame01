...
namespace PureMVC.Core
{
    ...
    public class View: IView
    {
        ...
        public View()
        {
            ...
            instance = this;
            mediatorMap = new ConcurrentDictionary<PanelName, IMediator>();
            observerMap = new ConcurrentDictionary<NotificationName, IList<IObserver>>();
            InitializeView();
        }
        ...
        public virtual void RegisterObserver(NotificationName notificationName, IObserver observer)
        {
        ...
        public virtual void RemoveObserver(NotificationName notificationName, object notifyContext)
        {
        ...
        public virtual void RegisterMediator(IMediator mediator)
        {
            ...
            if(mediatorMap.TryAdd(mediator.Name, mediator))
            {
                // Get Notification interests, if any.
                NotificationName[] interests = mediator.ListNotificationInterests();
        ...
        public virtual IMediator RetrieveMediator(PanelName mediatorName)
        {
        ...
        public virtual IMediator RemoveMediator(PanelName mediatorName)
        {
        ...
        public virtual bool HasMediator(PanelName mediatorName)
        {
            return mediatorMap.ContainsKey(mediatorName);
        }

        /// <summary>Mapping of Mediator names to Mediator instances</summary>
        protected readonly ConcurrentDictionary<PanelName, IMediator> mediatorMap;

        /// <summary>Mapping of Notification names to Observer lists</summary>
        protected readonly ConcurrentDictionary<NotificationName, IList<IObserver>> observerMap;
